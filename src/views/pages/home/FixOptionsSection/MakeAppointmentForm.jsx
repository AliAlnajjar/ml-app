...
export default function MakeAppointmentForm(props) {
  ...
  const sendMail = () => {
    if (!invalidForm()) {
      const mailDetails = composeEmail(
        name,
        address,
        email,
        mobileNo,
  ...
  const invalidForm = () => {
    ...
    if (
      ...
      validation.streetNo === null &&
      validation.Zip === null &&
      validation.city === null &&
      validation.mobileNo === null &&
      validation.phoneModel === null &&
          ...
          <Grid container item xs={12} spacing={1}>
            <Grid item xs={12}>
              <Typography variant="h5" component="h2" className={classes.title}>
                Ønsket service og mobilmodell{" "}
                <span className={classes.noteSpan}>(kun iPhone)</span>
              </Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} spacing={1}>
            ...
            <Grid item xs={12} md={6}>
              <Autocomplete
                ...
                onChange={(e, selectedDevice) => {
                  setPhoneModel(selectedDevice ? selectedDevice.text : null);
                  setvalidation({
                    ...validation,
                    phoneModel: selectedDevice ? false : true,
                  });
                }}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <Autocomplete
                ...
                onChange={(e, selectedService) => {
                  setService(selectedService ? selectedService.text : null);
                  setvalidation({
                    ...validation,
                    service: selectedService ? false : true,
                  });
                }}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setvalidation({
                    ...validation,
                    streetNo: e.target.value ? false : true,
                  });
                }}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setvalidation({
                    ...validation,
                    city: e.target.value ? false : true,
                  });
                }}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setvalidation({
                    ...validation,
                    mobileNo: e.target.value ? false : true,
                  });
                }}
              />
            </Grid>
          ...
          <Grid container item xs={12} spacing={1}>
            ...
            <Grid item xs={12} md={6}>
              <Autocomplete
                ...
                onChange={(e, time) => {
                  setTime(time ? time.text : "");
                  setvalidation({ ...validation, time: time ? false : true });
                }}
              />
            </Grid>
          </Grid>
